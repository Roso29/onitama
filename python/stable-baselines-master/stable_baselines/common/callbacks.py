    ...
    def _on_step(self) -> bool:
        ...
        if self.eval_freq > 0 and self.n_calls % self.eval_freq == 0:
            ...
            if winRate>self.win_rate_threshold and self.decrease_threshold:
                self.env.game.agent.threshold = self.env.game.agent.threshold - (self.threshold_decrease_factor)*0.1
                self.eval_env.game.agent.threshold = self.eval_env.game.agent.threshold - (self.threshold_decrease_factor)*0.1
